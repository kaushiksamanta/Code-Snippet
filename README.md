...
### Cloning The Code Snippets Repository
The recommended way to get Code Snippets is to use git to directly clone the code-snippets repository:

```bash
$ git clone https://github.com/kaushiksamanta/Code-Snippet.git
```

This will clone the latest version of the Code Snippet repository .
...
You can run the full test suite included with Code Snippets with the test task:
...
The Code Snippets project integrates Gulp as build tools and task automation.
